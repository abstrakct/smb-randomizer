...
$vanilla_level = [ 
    ...
    '2-2' => new Level('2-2', 0x01, 0x2181, null, [ 0x2181 + 4, 0x2181 + 7, 0x2181 + 10 ], null, true, '7-2'),
    '2-3' => new Level('2-3', 0x27, 0x1f4c, null,   null, true, '7-3'),
    '2-4' => new Level('2-4', 0x62, 0x1dc0, null,   null, true, '5-4'),
    '3-1' => new Level('3-1', 0x24, 0x1ee0, null, [ 0x1ee0 + 6, 0x1ee0 + 25]),
    ...
    '4-2' => new Level('4-2', 0x41, 0x2115, null, [ 0x2115 + 4, 0x2115 + 17, 0x2115 + 44 ]),
    '4-3' => new Level('4-3', 0x2c, 0x1fb9, null),
    '4-4' => new Level('4-4', 0x61, 0x1da7, null),
    '5-1' => new Level('5-1', 0x2a, 0x1f8c, null, [ 0x1f8c + 28 ]),
    '5-2' => new Level('5-2', 0x31, 0x2045, null, [ 0x2045 + 4, 0x2045 + 17 ]),
    '5-3' => new Level('5-3', 0x26, 0x1f2f, null),
    '5-4' => new Level('5-4', 0x62, 0x1dc0, null),
    '6-1' => new Level('6-1', 0x2e, 0x2001, null),
    '6-2' => new Level('6-2', 0x23, 0x1eb9, null, [ 0x1eb9 + 2, 0x1eb9 + 11, 0x1eb9 + 18, 0x1eb9 + 25]),
    '6-3' => new Level('6-3', 0x2d, 0x1fde, null),
    '6-4' => new Level('6-4', 0x60, 0x1d80, null),
    '7-1' => new Level('7-1', 0x33, 0x209e, null, [ 0x209e + 4 ]),
    '7-2' => new Level('7-2', 0x01, 0x2181, null, [ 0x2181 + 4, 0x2181 + 7, 0x2181 + 11 ]),
    '7-3' => new Level('7-3', 0x27, 0x1f4c, null),
    '7-4' => new Level('7-4', 0x64, 0x1e1a, null),
    '8-1' => new Level('8-1', 0x30, 0x200b, null, [ 0x200b + 6 ]),
    '8-2' => new Level('8-2', 0x32, 0x2070, null, [ 0x2070 + 26 ]),
