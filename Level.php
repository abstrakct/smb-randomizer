...
$vanilla_level = [ 
    ...
    '2-1' => new Level('2-1', 0x28, 0x1f61, 0x0000, null, [ [ 0x1f61 + 14, 0x1fb0 + 4 ],
                                                            [ 0x1f61 + 25, 0x2143 + 5 ] ],  6),
    '2-2' => new Level('2-2', 0x01, 0x2181, 0x0000, null, [ [ 0x2181 +  4, null ] ],        5 /*0x2181 + 7, 0x2181 + 10 ]*/),
    '2-3' => new Level('2-3', 0x27, 0x1f4c, 0x0000, null, null, 7),
    '2-4' => new Level('2-4', 0x62, 0x1dc0, 0x0000, null, null, 0),
    '3-1' => new Level('3-1', 0x24, 0x1ee0, 0x0000, null, [ [ 0x1ee0 +  6, 0x2143 + 21 ],
                                                            [ 0x1ee0 + 25, 0x20ba + 4  ] ], 6),
    '3-2' => new Level('3-2', 0x35, 0x20c3, 0x0000, null, null, 6),
    '3-3' => new Level('3-3', 0x20, 0x1e69, 0x0000, null, null, 4),
    '3-4' => new Level('3-4', 0x63, 0x1def, 0x0000, null, null, 0),
    '4-1' => new Level('4-1', 0x22, 0x1eab, 0x0000, null, [ [ 0x1eab +  2, 0x2143 + 26 ] ], 6),
    '4-2' => new Level('4-2', 0x41, 0x2115, 0x0000, null, [ [ 0x2115 +  4, null ],
                                                            [ 0x2115 + 17, 0x2143 + 34 ],
                                                            [ 0x2115 + 44, null ] ], 6),  // not sure if last null is correct, but probably (warp zone)
    '4-3' => new Level('4-3', 0x2c, 0x1fb9, 0x0000, null, null, 4),
    '4-4' => new Level('4-4', 0x61, 0x1da7, 0x0000, null, null, 0),
    '5-1' => new Level('5-1', 0x2a, 0x1f8c, 0x0000, null, [ [ 0x1f8c + 28, 0x2143 + 37 ] ], 6),
    '5-2' => new Level('5-2', 0x31, 0x2045, 0x0000, null, [ [ 0x2045 + 4,  0x2170 + 8 ],
                                                            [ 0x2045 + 17, 0x1fb0 + 7 ] ], 6),
    '5-3' => new Level('5-3', 0x26, 0x1f2f, 0x0000, null, null, 4),
    '5-4' => new Level('5-4', 0x62, 0x1dc0, 0x0000, null, null, 0),
    '6-1' => new Level('6-1', 0x2e, 0x2001, 0x0000, null, null, 6),
    '6-2' => new Level('6-2', 0x23, 0x1eb9, 0x0000, null, [ [ 0x1eb9 +  2, 0x2143 + 29 ],
                                                            [ 0x1eb9 + 11, 0x2170 + 11 ],
                                                            [ 0x1eb9 + 18, 0x20ba + 7 ],
                                                            [ 0x1eb9 + 25, 0x2143 + 40 ] ], 6),  // first, last exit unsure
    '6-3' => new Level('6-3', 0x2d, 0x1fde, 0x0000, null, null, 6),
    '6-4' => new Level('6-4', 0x60, 0x1d80, 0x0000, null, null, 0),
    '7-1' => new Level('7-1', 0x33, 0x209e, 0x0000, null, [ [ 0x209e +  4, 0x2143 + 8 ] ], 6),
    '7-2' => new Level('7-2', 0x01, 0x2181, 0x0000, null, [ [ 0x2181 + 10, null ] ], 5),
    '7-3' => new Level('7-3', 0x27, 0x1f4c, 0x0000, null, null, 7),
    '7-4' => new Level('7-4', 0x64, 0x1e1a, 0x0000, null, null, 0),
    '8-1' => new Level('8-1', 0x30, 0x200b, 0x0000, null, [ [ 0x200b + 6,  0x2143 + 16 ] ], 0),
    '8-2' => new Level('8-2', 0x32, 0x2070, 0x0000, null, [ [ 0x2070 + 26, 0x2143 + 43 ] ], 0),
    '8-3' => new Level('8-3', 0x21, 0x1e8e, 0x0000, null, null, 0),
    '8-4' => new Level('8-4', 0x65, 0x1e2f, 0x0000, null, null, 0),
